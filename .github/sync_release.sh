...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-CongoBongo_MiSTer.git"
CORE_NAME=(Arcade-CongoBongo)
...
UPSTREAM_CORE_NAME=(Arcade-CongoBongo)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-CongoBongo.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-CongoBongo.rbf)
